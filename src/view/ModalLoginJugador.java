...
public class ModalLoginJugador extends JDialog implements IGuiQuizApp {
	...
	public void inicializar() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ModalLoginJugador.class.getResource("/images/QuizIconSmall.png")));
		...
		//Label DNI
		lblDNI = new JLabel("DOCUMENTO NACIONAL DE IDENTIDAD");
	...
	public Jugador getDatos() {
		return new Jugador(txtDni.getText(), txtPassword.getText());
	}
