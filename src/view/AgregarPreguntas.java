...
public class AgregarPreguntas extends JPanel implements IGuiQuizApp {
	...
	public void inicializar() {
		...
		btnReset.setBackground(new Color(AppColorStyles.APP_MAIN_COLOR[0], AppColorStyles.APP_MAIN_COLOR[1] ,AppColorStyles.APP_MAIN_COLOR[2]));
		btnReset.setBounds(411, 449, 150, 50);
		add(btnReset);
	}
	...
	public Pregunta getDatos() {
		...
		if (txtPregunta.getText().isEmpty() || txtRespuestaCorrecta.getText().isEmpty() 
			...
			RespuestaIncorrecta r1 = new RespuestaIncorrecta(textRespuestaIncorrecta.getText());
			RespuestaIncorrecta r2 = new RespuestaIncorrecta(textRespuestaIncorrecta2.getText());
			RespuestaIncorrecta r3 = new RespuestaIncorrecta(textRespuestaIncorrecta3.getText());
			
			listRespuestasIncorrectas.add(r1);
			listRespuestasIncorrectas.add(r2);
			listRespuestasIncorrectas.add(r3);
			
			return new Pregunta(txtPregunta.getText(), txtRespuestaCorrecta.getText(), listRespuestasIncorrectas);
		}
	}
